...
import curiosityRover from "../assets/curiosityRover.jpg";
import opportunityRover from "../assets/opportunityRover.jpg";
import spiritRover from "../assets/spiritRover.jpg";

import "./styles/MarsStyles.css";
        ...
        <div
          className={
            dateTaken === ""
              ...
              ? "img-unavailable"
              : (dateSelected === true) & (allCuriosityPictures.length === 0)
              ? "img-unavailable"
              : ""
          }
        >
          <h4>Curiosity</h4>
          <img
            className={clickedRover === "curiosity" ? "highlight-rover" : ""}
            src={curiosityRover}
            alt="curiosity"
            name="selectedRover"
            onClick={(event) => {
        ...
        <div
          className={
            dateTaken === ""
              ...
              ? "img-unavailable"
              : (dateSelected === true) & (allOpportunityPictures.length === 0)
              ? "img-unavailable"
              : ""
          }
        >
          <h4>Opportunity</h4>
          <img
            className={clickedRover === "opportunity" ? "highlight-rover" : ""}
            src={opportunityRover}
            alt="opportunity"
            name="selectedRover"
            onClick={(event) => {
              handleChange(event);
        ...
        <div
          className={
            dateTaken === ""
              ...
              ? "img-unavailable"
              : (dateSelected === true) & (allSpiritPictures.length === 0)
              ? "img-unavailable"
              : ""
          }
        >
          <h4>Spirit</h4>
          <img
            className={clickedRover === "spirit" ? "highlight-rover" : ""}
            src={spiritRover}
            alt="spirit"
            name="selectedRover"
            onClick={(event) => {
