...
class MarsImage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      clickedImage: "",
      initialRender: false,
      containsImage: this.props.currentAlbum
        ? ""
        : "Please select a rover with images",
    };
  }
  ...
  clickExpandImage = (clickedImage) => {
    ...
    this.bindEscFunction(); // Bind escFunction when image is expanded
  };
  ...
  clickReset = () => {
    ...
    this.unbindEscFunction(); // Unbind escFunction when image is collapsed
  };
  ...
  // Function to bind escFunction to keydown event
  bindEscFunction = () => {
    document.addEventListener("keydown", this.escFunction, false);
  };

  // Function to unbind escFunction from keydown event
  unbindEscFunction = () => {
  ...
  render() {
    ...
    return (
      <div>
        ...
        <div>{this.state.containsImage}</div>
      </div>
    );
  }
}
