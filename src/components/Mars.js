        ...
        <div className="selection-area">
          ...
          <div className="rover-selection">
            <MarsRover
              ...
              loadingCuriosity={loadingCuriosity}
              loadingOpportunity={loadingOpportunity}
              loadingSpirit={loadingSpirit}
              allCuriosityPictures={allCuriosityPictures}
              allOpportunityPictures={allOpportunityPictures}
              allSpiritPictures={allSpiritPictures}
              highlightClickRover={this.highlightClickRover}
              handleChange={this.handleChange}
            />
          </div>
          <div className="retrieve-photos">
            <form onSubmit={this.handleSubmitAll}>
              <button className="btn btn-primary" hidden={!dateSelected}>
                Retrieve Photos
              </button>
            </form>
          </div>
